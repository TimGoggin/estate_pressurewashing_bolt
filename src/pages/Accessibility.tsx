    ...
    <div className={`min-h-screen ${darkMode ? "bg-gray-900 text-white" : "bg-white text-gray-800"}`}>
      ...
      <div className="container mx-auto px-6 py-12">
        <article className={`prose ${darkMode ? "prose-invert" : ""} max-w-4xl mx-auto`}>
          ...
          <p>The website features an accessibility menu. A click on the menu makes accessibility buttons available. After selecting a menu item, the user should wait for the page to be loaded.</p>
          ...
          <p>Our website is designed to be compatible with assistive technologies and the last two versions of major browsers.</p>
          ...
          <p>We assess the accessibility of our website by self-evaluation and annual review.</p>
